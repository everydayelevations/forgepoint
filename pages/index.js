...
export default function Clavex() {
  ...
  return (
    <>
      <Head>
        <title>Clavex — Highland Cabinetry</title>
      ...
      <div className="layout">
        ...
        <aside className="sidebar">
          <div className="sidebar-top">
            <div className="brand">
              ...
              {navOpen && <div className="brand-text"><div className="brand-name">Clavex</div><div className="brand-sub">The key between design and delivery.</div></div>}
            </div>
          </div>
        ...
        <div className="main">
          <div className="topbar">
            ...
            <div className="topbar-meta">Clavex · 8th Ascent AI</div>
          </div>
